...
const demos = [
  { name: 'Radar', category: 'EXECUTIVE RECRUITING', title: 'Your personal executive recruiter.', copy: 'Radar combines market signals with your context and spikes to find high-fit opportunities and curate every step from outreach to interview.', href: '/demos/interview', action: 'Explore Radar', note: '6-step guided journey · Fictional candidate', tone: 'radar' },
